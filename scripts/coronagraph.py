    ...
    def add_plan(self,
        ...
        for i in range(self.scene.Nplanets):
            ...
            if ((self.type == '1dx') or (self.type == '1dy')):
                ...
                temp = np.dot(plan_seps[i][:, None]*mas2rad, wave_inv[None])*0.9*self.diam # lambda/D
                
# =============================================================================
#                 print("\n plan seps:", plan_seps[i][:, None])
#                 print("lamD that coronagraph thinks is it", temp)
#                 print(" diam", self.diam)
#                 assert False
# =============================================================================
